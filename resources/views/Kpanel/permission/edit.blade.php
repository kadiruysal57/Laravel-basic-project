                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab"
                                       href="#role">{{__('permission.role')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab"
                                       href="#permission">{{__('permission.permission')}}</a>
                                </li>
                            </ul>

                        </div>
                        <form id="permission_update" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="role">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{$permission->name}}" name="name" required
                                               type="text">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" tabindex="-98">
                                            ...
                                            <option @if($permission->status == 1) selected
                                                    @endif value="1">{{__('global.active')}}</option>
                                            <option @if($permission->status == 2) selected
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            @foreach($permission->users_roles as $rt)
                                                @if(!empty($rt->roles_table->roles_name))
                                                    <div class="d-grid col-3 text-center border-roles">
                                                        ...
                                                        <label class="switch">
                                                            <input class="form-check-input "
                                                                   name="edit_permission{{$rt->id}}"
                                                                   @if($rt->status == 1) checked @endif type="checkbox"
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-w-md btn-round btn-primary "
                                        form="permission_update">{{__('global.save')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
