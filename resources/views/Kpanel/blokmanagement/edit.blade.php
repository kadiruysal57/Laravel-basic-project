        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="default_blok_edit" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                              action="{{route('blok-management.store')}}">
                            <input type="hidden" name="id" value="update">
                            <input type="hidden" name="blok_id" value="{{$default_blok->id}}">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label for="blok_name">{{__('blokmanagement.blok_management_name')}}</label>
                                    <input type="text" value="{{$default_blok->default_blok_name}}" name="blok_name" class="form-control" id="blok_name"
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 " style="border-radius: 10px;">
                                        ...
                                        <div class="form-group">
                                            <label class="switch switch-success col-lg-5">
                                                <input type="checkbox" @if($default_blok->left_blok_active == 1) checked="" @endif class="left_blok"
                                                       name="left_blok">
                                            ...
                                            <label class="switch switch-success col-lg-5">
                                                <input type="checkbox" @if($default_blok->right_blok_active == 1) checked="" @endif class="right_blok"
                                                       name="right_blok">
                                                <span class="switch-indicator"></span>
                                                <span
                                                ...
                                                @foreach($blok_groups as $key => $b)
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="dd" id="{{$b->name}}_nestable">
                                                            <ol class="dd-list">
                                                                @foreach($b->group_file->whereNotIn('id',array_only($default_blok->blok_file->where('group_id',$b->id)->where('html','==',null)->toArray(),'blok_files_id')) as $bf)
