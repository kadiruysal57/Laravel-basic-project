                ...
                <div class="card">
                    <header class="card-header">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><i class="fa fa-edit"></i> {{__('contents.contents_update_title')}}</li>
                        </ol>
                    </header>
                    <div class="card-body">
                        <div class="d-flex ">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="contents-genel-info">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " name="name" required type="text" value="{{$contents->name}}">
                                    </div>
                                    <div class="form-group">
                                        <label class="require">{{__('global.title')}}</label>
                                        <input class="form-control " name="title" required type="text" value="{{$contents->title}}">
                                    </div>
                                    <div class="form-group">
                                        <label class="require">{{__('global.short_desc')}}</label>
                                        <textarea name="short_desc" class="form-control">{{$contents->short_desc}}</textarea>
                                    </div>
                                ...
                                <div class="tab-pane fade " id="contents-seo">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " name="seo_title" required type="text" value="{{$contents->seo_title}}">

                                    </div>
                                    <div class="form-group">
                                        <label class="require">{{__('contents.keywords')}}</label>
                                        <input class="form-control " name="keywords" required type="text" value="{{$contents->keywords}}">
                                    </div>
                                    <div class="form-group">
                                        <label class="require">{{__('contents.seo_description')}}</label>
                                        <textarea name="seo_description" class="form-control">{{$contents->seo_description}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="require">{{__('contents.focus_keywords')}}</label>
                                        <input class="form-control " name="focus_keywords" required type="text" value="{{$contents->focus_keywords}}">
                                    </div>

                                    <div class="form-group">
                                        <label class="require">{{__('global.slug')}}</label>
                                        <input class="form-control " name="seo_url" required type="text" value="{{$contents->seo_url}}">
                                    </div>
