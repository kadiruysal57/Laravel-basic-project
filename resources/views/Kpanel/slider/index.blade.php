            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <header class="card-header">
                        <h4 class="card-title">{{__('slider.slider_page_title')}}</strong></h4>
                        <div class="text-right">
                            <a class="btn btn-success btn-sm" href="{{route('slider.create')}}"><i
                    ...
                    <div class="card-body">
                        <div class="col">
                                ...
                                <div class="">
                                    <table class="table table-separated dataTables" id="slider">
                                        <thead>
                                        <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media">
                                                            ...
                                                            @endif
                                                            @if(!empty($s->slider_image_one))
                                                                <img class="avatar" src="{{$s->slider_image_one->url}}"
                                                                     alt="slider image">
                                                            @endif
                                                    ...
                                                    <td class="text-right table-actions">
                                                        <a class="table-action hover-primary" href="{{route('slider.show',[$s->id])}}"><i class="ti-pencil"></i></a>
                                                        <a class="table-action hover-danger deleteButton"
                                                           data-id="{{$s->id}}"
                                                           data-action="{{route('slider.destroy',[$s->id])}}"
                                                           data-table="#slider"
